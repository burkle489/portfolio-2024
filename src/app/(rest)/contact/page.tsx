...
const Contact = () => {
  return (
    <div className="pointer-events-none w-screen h-screen relative z-50 pt-56 py-32 px-2 sm:px-6 md:px-12 lg:px-20 flex flex-col justify-start gap-20 sm:gap-40 md:gap-60">
      <Heading
        variant="h1"
