...
import BgSVG5 from "@/components/svgs/components/BgSVG5"
import { useGSAP } from "@gsap/react"
import { FC, useRef } from "react"
import gsap from "gsap"

const GreenContent: FC = () => {
  ...
  return (
    <div className="scale-50 md:scale-[85%] absolute z-10 w-[70rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
