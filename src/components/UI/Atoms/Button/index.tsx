...
const Button: FC<IButtonProps> = ({ text, className, ...buttonProps }) => {
  return (
    ...
    >
      ...
      <div className="rounded absolute left-0 top-0 dark-complex-radial-gradient h-full w-6 group-hover:w-full duration-500 transition-all z-10 pointer-events-none">
